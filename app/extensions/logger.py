...
def initialize_notice_level():
    """Инициализация уровня логирования NOTICE.
...
class CustomFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        """Форматирует запись лог-сообщения.
...
def get_handler(log_format: str) -> logging.Handler:
    ...
    логов в файл/файл с ротациями или вывода в стандартный поток.
